...
from queries import get_students_list, get_student, get_students_with_teachers_list, get_student_by_name,delete_student_by_id, get_students_by_teacher_name, create_student, update_student_by_id
